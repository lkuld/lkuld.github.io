...
\end{figure}
	...
	\begin{minipage}[b]{0.4\linewidth}
		\begin{itemize}
			\item Falls sich das Preisverhältnis ändert, z.B. weil sich nur ein einzelner Preis ändert, ändert sich die Steigung der Budget-Geraden 
...
\end{figure}
	...
	\begin{minipage}[b]{0.4\linewidth}
		\begin{itemize}
			...
			\item Dann passt sich der Quadratmeterpreis an, damit der Nutzen konstant bleibt: $p_q \downarrow$
		\end{itemize}
	\end{minipage}
}
...
\end{figure}
	...
	\begin{minipage}[b]{0.4\linewidth}
		\begin{itemize}
			\item Gegeben die gezeigte Budgetgerade, erreicht der Haushalt im Punkt $(q_0,c_0)$ den höchsten Nutzen
		\end{itemize}
	\end{minipage}
}
